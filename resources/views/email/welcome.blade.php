...
<html xmlns="http://www.w3.org/1999/xhtml" style="background-color: #cfbc1b">
...
<style type="text/css">
    ...
    .Button-primary {
        ...
        border: 1px solid #cfbc1b !important;
        color: #333 !important;
        display: block !important;
        font-size: 16px !important;
        font-weight: 600 !important;
                ...
                <tr>
                    <td align="left" valign="middle" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; display: table-cell;">
                        <a href="http://weavonhair.com" target="_blank" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
                            <!--TOP IMAGE-->
                            <img src="{{ url('images/niu.png') }}" width="74" height="22" alt="logo" border="0" class="header-tockLogoImage" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; display: block; color: rgb(240, 240, 240);" />
